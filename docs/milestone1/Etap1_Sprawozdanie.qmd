...
Po pewnym czasie zorientowałem się, że `SET search_path` działa tylko w biedzącej sesji. Ponieważ za każdym raziem chciałem korzystać ze schematu `main` zmieniłem `search_path` na poziomie bazy danych zgodnie z artykułem How Do I Set/Change the Default Schema in PostgreSQL @commandprompt:how-to-set-change-default-schema-postgresql.


<!-- Odchodzę od 3NF w language i currency, ponieważ nazwy języków się nie zmieniają -->
