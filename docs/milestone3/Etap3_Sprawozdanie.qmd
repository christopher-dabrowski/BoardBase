...
<!-- TODO: Spróbować dodać informacje o wydziale -->
...
<!-- Był obraz bazowy na Ubunu i Readhat -->
...
Po uruchomieniu kontenera połączyłem się do niego `mongosh` i pobrałem informacje o bazie poleceniem `db.runCommand({hello:1})`. \
