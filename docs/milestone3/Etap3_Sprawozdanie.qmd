...
Ciekawe było też dla mnie to, że przy analizie zapytania korzystającego z indeksu klastrowanego analiza zapytania pokazuje, że nie został użyty żaden indeks `"indexesUsed": [],`.
Jestem jednak pewien, że indeks klastrowany został użyty, ponieważ w przeciwnym razie wykonanie trwałoby znacznie dłużej.

# Wnioski

<!-- Brak warstwy widoków z ANSI-SPAC, jednak są widoki ale nie można modyfikować ich wartości -->
