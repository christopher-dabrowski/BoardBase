...
Ponieważ chciałbym widzieć każdą daną jako oddzielny dokument, przygotowałem skrypty skrypty transformujące dane i wczytujące je do bazy za pomocą `mongoimport` i `jq`.
