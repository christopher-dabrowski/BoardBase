...
<!-- Stwórz indeksy na odpowiednich polach kolekcji. Przedstaw na praktycznych przykładach
wydajność zapytań pokrytych różną liczbą indeksów.
Uwaga: Dla pełnych punktów polecane jest porównanie zapytań pokrytych różną liczbą
indeksów oraz indeksami prostymi i kompozytowymi oraz wnioski prezentujące zrozumienie
działania indeksów w MongoDB (i czym się różnią od działania indeksów w bazach
relacyjnych). Polecam posłużyć się analizatorem zapytań. -->
