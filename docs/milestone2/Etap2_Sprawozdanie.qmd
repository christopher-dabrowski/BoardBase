...
Niestety najnowsza wspierana wersja bazy PostgreSQL to 16.x @sqlines:postgresql-to-sql-server, a niestety moja baza jest w wersji 18.0, ale może i tak zadziała. \
Narzędzie to jest dostępne tylko w wersji na system Windows. \
