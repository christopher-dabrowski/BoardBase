...
Działanie \acr{SZBD} sprawdziłem za łącząc się z terminala narzędziem [`sqlcmd`](https://learn.microsoft.com/en-us/sql/tools/sqlcmd/sqlcmd-utility?view=sql-server-ver17&tabs=go%2Cwindows-support&pivots=cs1-bash) i pobierając wersję zapytaniem:
...
Otrzymałem spodziewany wynik @tbl-sql-server-version.
...
: Wersja SQL Server {#tbl-sql-server-version}
