...
Sprawdziłem też, że poprawnie zostały przeniesione moje `CONSTRAINT` dbające na przykład o poprawność formatu maili czy niedopuszczanie pustych wartości w niektórych kolumnach. Miło mnie to zaskoczyło. \
Przeniosły się też reguły kaskadowego usuwania danych na podstawie kluczy obcych.

Przeniesienie danych za pomocą narzędzia [DBeaver](https://dbeaver.io/) było zaskakująco proste.
