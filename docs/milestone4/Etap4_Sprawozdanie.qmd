...
Wykorzystałem w nim funkcję odległości `point.distance`.
...
Następnie korzystając z funkcji przestrzennej `point.withinBBox()` wylistowałem chronologicznie bitwy w tym obszarze w zapytaniu [`battles_in_bounding_box.cypher`](https://github.com/christopher-dabrowski/BoardBase/blob/main/neo4j/spatial/battles_in_bounding_box.cypher).
