...
Skrypt zapisałem jako [`add_coordinates.py`](https://github.com/christopher-dabrowski/BoardBase/blob/main/neo4j/spatial/add_coordinates.py) i uruchomiłem generujac plik \acr{CSC} z danymi przestrzennymi.
