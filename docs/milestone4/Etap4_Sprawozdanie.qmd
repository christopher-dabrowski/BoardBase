...
Przeczytałem, że domyślnie format pliku konfiguracyjnego to _ISO-8859-1_, co może powodować problemy, gdybym używał polskich znaków. Zmieniłem go na _UTF-8_ ustawiając zmienną środowiskową @neo4j:neo4j-conf.
