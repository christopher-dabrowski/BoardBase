...
--
-- Name: want_level_enum; Type: TYPE; Schema: main; Owner: postgres
--
...
--
-- Name: add_game_wish(integer, main.want_level_enum, character varying); Type: PROCEDURE; Schema: main; Owner: postgres
--

CREATE PROCEDURE main.add_game_wish(IN board_game_id integer, OUT new_game_wish_id integer, IN want_level main.want_level_enum DEFAULT 'WANT_TO_PLAY'::main.want_level_enum, IN note character varying DEFAULT NULL::character varying)
    LANGUAGE sql
    AS $$
    WITH user_data AS (
        SELECT user_id
...
ALTER PROCEDURE main.add_game_wish(IN board_game_id integer, OUT new_game_wish_id integer, IN want_level main.want_level_enum, IN note character varying) OWNER TO postgres;

--
-- Name: add_location(character varying, character varying, character varying); Type: PROCEDURE; Schema: main; Owner: postgres
--

CREATE PROCEDURE main.add_location(IN name character varying, OUT new_location_id integer, IN address character varying DEFAULT NULL::character varying, IN description character varying DEFAULT NULL::character varying)
    LANGUAGE sql
    AS $$
    WITH user_data AS (
        SELECT user_id
...
ALTER PROCEDURE main.add_location(IN name character varying, OUT new_location_id integer, IN address character varying, IN description character varying) OWNER TO postgres;

--
-- Name: add_rating(integer, integer, integer, integer, integer, integer, integer); Type: PROCEDURE; Schema: main; Owner: postgres
--

CREATE PROCEDURE main.add_rating(IN board_game_id integer, IN enjoyment integer, OUT new_rating_id integer, IN minimal_player_count integer DEFAULT NULL::integer, IN maximum_player_count integer DEFAULT NULL::integer, IN best_player_count integer DEFAULT NULL::integer, IN minimal_age integer DEFAULT NULL::integer, IN complexity integer DEFAULT NULL::integer)
    LANGUAGE sql
    AS $$
    WITH user_data AS (
        SELECT user_id
...
ALTER PROCEDURE main.add_rating(IN board_game_id integer, IN enjoyment integer, OUT new_rating_id integer, IN minimal_player_count integer, IN maximum_player_count integer, IN best_player_count integer, IN minimal_age integer, IN complexity integer) OWNER TO postgres;

--
-- Name: add_review(integer, character varying, integer); Type: PROCEDURE; Schema: main; Owner: postgres
--

CREATE PROCEDURE main.add_review(IN board_game_id integer, IN review_text character varying, OUT new_review_id integer, IN hours_spent_playing integer DEFAULT NULL::integer)
    LANGUAGE sql
    AS $$
    WITH user_data AS (
        SELECT user_id
...
ALTER PROCEDURE main.add_review(IN board_game_id integer, IN review_text character varying, OUT new_review_id integer, IN hours_spent_playing integer) OWNER TO postgres;

--
-- Name: add_user(character varying, character varying, character varying, boolean); Type: PROCEDURE; Schema: main; Owner: postgres
--

CREATE PROCEDURE main.add_user(IN username character varying, IN email character varying, IN password character varying, OUT new_user_id integer, IN is_admin boolean DEFAULT false)
    LANGUAGE sql
    AS $$
...
ALTER PROCEDURE main.add_user(IN username character varying, IN email character varying, IN password character varying, OUT new_user_id integer, IN is_admin boolean) OWNER TO postgres;

--
-- Name: fair_game_rating(integer, integer); Type: FUNCTION; Schema: main; Owner: postgres
--

CREATE FUNCTION main.fair_game_rating(game_id integer, minimum_rating_count integer DEFAULT 10) RETURNS numeric
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION main.fair_game_rating(game_id integer, minimum_rating_count integer) OWNER TO postgres;

--
-- Name: merge_user_accounts(integer, integer); Type: PROCEDURE; Schema: main; Owner: postgres
--

CREATE PROCEDURE main.merge_user_accounts(IN source_user_id integer, IN target_user_id integer)
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER PROCEDURE main.merge_user_accounts(IN source_user_id integer, IN target_user_id integer) OWNER TO postgres;

--
-- Name: remove_from_wishlist_on_acquire(); Type: FUNCTION; Schema: main; Owner: postgres
--
...
ALTER FUNCTION main.remove_from_wishlist_on_acquire() OWNER TO postgres;

--
-- Name: update_player_count_on_participant_add(); Type: FUNCTION; Schema: main; Owner: postgres
--

CREATE FUNCTION main.update_player_count_on_participant_add() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION main.update_player_count_on_participant_add() OWNER TO postgres;

--
-- Name: validate_player_count_on_play_update(); Type: FUNCTION; Schema: main; Owner: postgres
--

CREATE FUNCTION main.validate_player_count_on_play_update() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
ALTER FUNCTION main.validate_player_count_on_play_update() OWNER TO postgres;
...
--
-- Name: app_user; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.app_user (
    ...
    CONSTRAINT user_username_not_empty CHECK ((TRIM(BOTH FROM username) <> ''::text))
);
...
--
-- Name: app_user_user_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.app_user ALTER COLUMN user_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.app_user_user_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: award; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.award (
    ...
    CONSTRAINT award_name_not_empty CHECK ((TRIM(BOTH FROM name) <> ''::text))
);
...
--
-- Name: TABLE award; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.award IS 'Awards that board games can receive (e.g., Spiel des Jahres)';


--
-- Name: award_award_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.award ALTER COLUMN award_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.award_award_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: award_board_game; Type: TABLE; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE award_board_game; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.award_board_game IS 'Table linking awards to the board games that received them';


--
-- Name: board_game; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.board_game (
    ...
    CONSTRAINT board_game_name_not_empty CHECK ((TRIM(BOTH FROM name) <> ''::text)),
...
--
-- Name: TABLE board_game; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.board_game IS 'General information about board game';


--
-- Name: board_game_board_game_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.board_game ALTER COLUMN board_game_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.board_game_board_game_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: board_game_category; Type: TABLE; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE board_game_category; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.board_game_category IS 'Board game can belong to multiple categories';


--
-- Name: board_game_mechanic; Type: TABLE; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE board_game_mechanic; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.board_game_mechanic IS 'Board game can use multiple mechanics';


--
-- Name: category; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.category (
    ...
    CONSTRAINT category_name_not_empty CHECK ((TRIM(BOTH FROM name) <> ''::text))
);
...
--
-- Name: TABLE category; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.category IS 'Dictionary of board game categories';


--
-- Name: category_category_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.category ALTER COLUMN category_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.category_category_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: game_release; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.game_release (
    ...
    CONSTRAINT game_release_language_not_empty CHECK ((TRIM(BOTH FROM language) <> ''::text))
);
...
--
-- Name: TABLE game_release; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.game_release IS 'Specific releases/editions of board games (language-specific, publisher-specific)';


--
-- Name: COLUMN game_release.language; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON COLUMN main.game_release.language IS 'Language of this release (e.g., English, Polish, German)';


--
-- Name: mechanic; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.mechanic (
    ...
    description character varying(500),
    CONSTRAINT mechanic_name_not_empty CHECK ((TRIM(BOTH FROM name) <> ''::text))
);
...
--
-- Name: TABLE mechanic; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.mechanic IS 'Dictionary of game mechanics';


--
-- Name: play; Type: TABLE; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE play; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.play IS 'Log of game sessions';


--
-- Name: publisher; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.publisher (
    ...
    description character varying(1000),
    CONSTRAINT publisher_name_not_empty CHECK ((TRIM(BOTH FROM name) <> ''::text)),
    CONSTRAINT publisher_website_url_format CHECK (((website_url IS NULL) OR ((website_url)::text ~* '^https?://.+'::text)))
);
...
--
-- Name: TABLE publisher; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.publisher IS 'Publishers who release board games';


--
-- Name: rating; Type: TABLE; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE rating; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.rating IS 'User ratings for board games (one rating per user per game)';


--
-- Name: COLUMN rating.enjoyment; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON COLUMN main.rating.enjoyment IS 'Overall enjoyment rating (1-10 scale)';


--
-- Name: COLUMN rating.complexity; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON COLUMN main.rating.complexity IS 'Perceived complexity (1-5 scale, where 5 is most complex)';


--
-- Name: game_catalog; Type: VIEW; Schema: main; Owner: postgres
--
...
CREATE VIEW main.game_catalog AS
 SELECT bg.board_game_id,
    ...
    string_agg(DISTINCT (c.name)::text, ', '::text ORDER BY (c.name)::text) AS categories,
    string_agg(DISTINCT (m.name)::text, ', '::text ORDER BY (m.name)::text) AS mechanics,
...
--
-- Name: VIEW game_catalog; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON VIEW main.game_catalog IS 'Main game catalog';


--
-- Name: game_wish; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.game_wish (
    ...
    wished_at timestamp without time zone DEFAULT CURRENT_TIMESTAMP NOT NULL
);
...
--
-- Name: TABLE game_wish; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.game_wish IS 'User wishlist for board games they want to acquire';


--
-- Name: review; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.review (
    ...
    CONSTRAINT review_text_not_empty CHECK ((TRIM(BOTH FROM review_text) <> ''::text))
);
...
--
-- Name: TABLE review; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.review IS 'User-written reviews for board games';


--
-- Name: COLUMN review.hours_spent_playing; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON COLUMN main.review.hours_spent_playing IS 'Total hours user spent playing this game';


--
-- Name: user_game_release; Type: TABLE; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE user_game_release; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.user_game_release IS 'Users can onw game releases';


--
-- Name: game_popularity_stats; Type: MATERIALIZED VIEW; Schema: main; Owner: postgres
--
...
CREATE MATERIALIZED VIEW main.game_popularity_stats AS
 SELECT bg.board_game_id,
    ...
    count(DISTINCT
        CASE
            WHEN (p.play_date >= (CURRENT_DATE - '90 days'::interval)) THEN p.play_id
            ELSE NULL::integer
    ...
    (((count(DISTINCT gw.game_wish_id))::numeric + (0.5 * (count(DISTINCT ugr.user_id))::numeric)) + ((10 * count(DISTINCT abg.award_id)))::numeric) AS popularity_score
   FROM (((((((main.board_game bg
     LEFT JOIN main.rating r ON ((bg.board_game_id = r.board_game_id)))
...
--
-- Name: price; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.price (
    ...
    end_date date,
    CONSTRAINT price_amount_positive CHECK ((amount >= (0)::numeric)),
    CONSTRAINT price_currency_format CHECK ((currency ~ '^[A-Z]{3}$'::text)),
...
--
-- Name: TABLE price; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.price IS 'Historical pricing information for game releases';


--
-- Name: COLUMN price.end_date; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON COLUMN main.price.end_date IS 'When the price is still present use NULL';


--
-- Name: game_prices_current; Type: VIEW; Schema: main; Owner: postgres
--
...
CREATE VIEW main.game_prices_current AS
 SELECT bg.board_game_id,
    ...
    pr.start_date AS price_start_date,
        CASE
            WHEN (pr.amount < (30)::numeric) THEN 'Budget'::text
            WHEN (pr.amount < (60)::numeric) THEN 'Standard'::text
            WHEN (pr.amount < (100)::numeric) THEN 'Premium'::text
            ELSE 'Luxury'::text
        END AS price_tier
   FROM (((main.board_game bg
...
--
-- Name: VIEW game_prices_current; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON VIEW main.game_prices_current IS 'Current market prices for all game releases';


--
-- Name: game_release_game_release_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.game_release ALTER COLUMN game_release_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.game_release_game_release_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: game_wish_game_wish_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.game_wish ALTER COLUMN game_wish_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.game_wish_game_wish_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: games_missing_metadata; Type: VIEW; Schema: main; Owner: postgres
--
...
CREATE VIEW main.games_missing_metadata AS
 ...
 HAVING ((count(DISTINCT bgc.category_id) = 0) OR (count(DISTINCT bgm.mechanic_id) = 0))
  ORDER BY (count(DISTINCT bgc.category_id)), (count(DISTINCT bgm.mechanic_id));


ALTER VIEW main.games_missing_metadata OWNER TO postgres;

--
-- Name: VIEW games_missing_metadata; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON VIEW main.games_missing_metadata IS 'Shows board games without categories or mechanics';


--
-- Name: location; Type: TABLE; Schema: main; Owner: postgres
--
...
CREATE TABLE main.location (
    ...
    CONSTRAINT location_name_not_empty CHECK ((TRIM(BOTH FROM name) <> ''::text))
);
...
--
-- Name: TABLE location; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.location IS 'Physical locations where games can be played (e.g., game cafes, homes)';


--
-- Name: location_location_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.location ALTER COLUMN location_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.location_location_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: mechanic_mechanic_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.mechanic ALTER COLUMN mechanic_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.mechanic_mechanic_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: play_participant; Type: TABLE; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE play_participant; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON TABLE main.play_participant IS 'Track which users participated in play sessions';


--
-- Name: play_play_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.play ALTER COLUMN play_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.play_play_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: price_price_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.price ALTER COLUMN price_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.price_price_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: publisher_publisher_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.publisher ALTER COLUMN publisher_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.publisher_publisher_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: rating_rating_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.rating ALTER COLUMN rating_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.rating_rating_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: review_review_id_seq; Type: SEQUENCE; Schema: main; Owner: postgres
--

ALTER TABLE main.review ALTER COLUMN review_id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME main.review_review_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: user_game_collection; Type: VIEW; Schema: main; Owner: postgres
--
...
CREATE VIEW main.user_game_collection AS
 SELECT u.user_id,
    ...
    pr.currency,
    (EXTRACT(year FROM age((CURRENT_DATE)::timestamp without time zone, ugr.acquired_at)))::integer AS years_owned,
        CASE
  ...
  WHERE ((u.username)::text = CURRENT_USER)
...
--
-- Name: VIEW user_game_collection; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON VIEW main.user_game_collection IS 'Shows user specific game collection';


--
-- Name: user_play_history; Type: VIEW; Schema: main; Owner: postgres
--
...
CREATE VIEW main.user_play_history AS
 SELECT pl.play_id,
    ...
    pl.note,
    string_agg(DISTINCT (u.username)::text, ', '::text ORDER BY (u.username)::text) AS participants,
        CASE
            WHEN ((pl.duration_in_minutes IS NOT NULL) AND (pl.duration_in_minutes < 60)) THEN 'Quick'::text
            WHEN ((pl.duration_in_minutes >= 60) AND (pl.duration_in_minutes < 120)) THEN 'Standard'::text
            WHEN ((pl.duration_in_minutes >= 120) AND (pl.duration_in_minutes < 180)) THEN 'Long'::text
            WHEN (pl.duration_in_minutes >= 180) THEN 'Epic'::text
            ELSE 'Unknown'::text
...
--
-- Name: VIEW user_play_history; Type: COMMENT; Schema: main; Owner: postgres
--

COMMENT ON VIEW main.user_play_history IS 'Complete current user play session log';
...
--
-- Data for Name: app_user; Type: TABLE DATA; Schema: main; Owner: postgres
--
...
--
-- Data for Name: award; Type: TABLE DATA; Schema: main; Owner: postgres
--
...
--
-- Data for Name: location; Type: TABLE DATA; Schema: main; Owner: postgres
--
...
3	2	4	Ticket to Ride is the perfect gateway game. Simple enough to teach to non-gamers, yet strategic enough to keep experienced players engaged. The tension of watching your routes get blocked is real! We've introduced dozens of friends to modern board gaming with this title. The various map expansions add great replay value. A true classic that deserves its place in every collection.	80	2015-08-25 14:15:00
...
10	8	5	Splendor is my favorite filler game. The chip-collecting and card-buying mechanism creates a satisfying engine that builds throughout the game. It's easy to teach but has surprising depth in timing your purchases and blocking opponents. Games are quick, making it perfect for lunch breaks or as a warm-up. The components feel premium, and the Renaissance theme works well.	50	2016-03-20 18:45:00
...
--
-- Data for Name: user_game_release; Type: TABLE DATA; Schema: main; Owner: postgres
--
...
--
-- Name: app_user_user_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: award_award_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: board_game_board_game_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: category_category_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: game_release_game_release_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: game_wish_game_wish_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: location_location_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: mechanic_mechanic_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: play_play_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: price_price_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: publisher_publisher_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: rating_rating_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: review_review_id_seq; Type: SEQUENCE SET; Schema: main; Owner: postgres
--
...
--
-- Name: app_user app_user_email_key; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: app_user app_user_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: app_user app_user_username_key; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: award_board_game award_board_game_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.award_board_game
    ADD CONSTRAINT award_board_game_pkey PRIMARY KEY (award_id, board_game_id);


--
-- Name: award award_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: board_game_category board_game_category_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.board_game_category
    ADD CONSTRAINT board_game_category_pkey PRIMARY KEY (board_game_id, category_id);


--
-- Name: board_game_mechanic board_game_mechanic_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.board_game_mechanic
    ADD CONSTRAINT board_game_mechanic_pkey PRIMARY KEY (board_game_id, mechanic_id);


--
-- Name: board_game board_game_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.board_game
    ADD CONSTRAINT board_game_pkey PRIMARY KEY (board_game_id);


--
-- Name: category category_name_key; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: category category_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: game_release game_release_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.game_release
    ADD CONSTRAINT game_release_pkey PRIMARY KEY (game_release_id);


--
-- Name: game_wish game_wish_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.game_wish
    ADD CONSTRAINT game_wish_pkey PRIMARY KEY (game_wish_id);


--
-- Name: game_wish game_wish_user_game_unique; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: location location_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: mechanic mechanic_name_key; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: mechanic mechanic_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: play_participant play_participant_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.play_participant
    ADD CONSTRAINT play_participant_pkey PRIMARY KEY (play_id, user_id);


--
-- Name: play play_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: price price_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: publisher publisher_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: rating rating_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: rating rating_user_game_unique; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: review review_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--
...
--
-- Name: user_game_release user_game_release_pkey; Type: CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.user_game_release
    ADD CONSTRAINT user_game_release_pkey PRIMARY KEY (user_id, game_release_id);


--
-- Name: idx_board_game_min_age; Type: INDEX; Schema: main; Owner: postgres
--

CREATE INDEX idx_board_game_min_age ON main.board_game USING btree (declared_minimal_age);


--
-- Name: idx_board_game_name; Type: INDEX; Schema: main; Owner: postgres
--

CREATE INDEX idx_board_game_name ON main.board_game USING btree (name);


--
-- Name: idx_board_game_player_count; Type: INDEX; Schema: main; Owner: postgres
--

CREATE INDEX idx_board_game_player_count ON main.board_game USING btree (declared_minimal_player_count, declared_maximum_player_count);


--
-- Name: user_game_release trg_remove_from_wishlist_on_acquire; Type: TRIGGER; Schema: main; Owner: postgres
--

CREATE TRIGGER trg_remove_from_wishlist_on_acquire AFTER INSERT ON main.user_game_release FOR EACH ROW EXECUTE FUNCTION main.remove_from_wishlist_on_acquire();


--
-- Name: play_participant trg_update_player_count_on_participant_add; Type: TRIGGER; Schema: main; Owner: postgres
--

CREATE TRIGGER trg_update_player_count_on_participant_add BEFORE INSERT ON main.play_participant FOR EACH ROW EXECUTE FUNCTION main.update_player_count_on_participant_add();


--
-- Name: play trg_validate_player_count_on_play_update; Type: TRIGGER; Schema: main; Owner: postgres
--

CREATE TRIGGER trg_validate_player_count_on_play_update BEFORE UPDATE ON main.play FOR EACH ROW EXECUTE FUNCTION main.validate_player_count_on_play_update();


--
-- Name: award_board_game fk_award_board_game_award; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.award_board_game
    ADD CONSTRAINT fk_award_board_game_award FOREIGN KEY (award_id) REFERENCES main.award(award_id) ON DELETE CASCADE;


--
-- Name: award_board_game fk_award_board_game_game; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.award_board_game
    ADD CONSTRAINT fk_award_board_game_game FOREIGN KEY (board_game_id) REFERENCES main.board_game(board_game_id) ON DELETE CASCADE;


--
-- Name: board_game_category fk_board_game_category_category; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.board_game_category
    ADD CONSTRAINT fk_board_game_category_category FOREIGN KEY (category_id) REFERENCES main.category(category_id) ON DELETE CASCADE;


--
-- Name: board_game_category fk_board_game_category_game; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.board_game_category
    ADD CONSTRAINT fk_board_game_category_game FOREIGN KEY (board_game_id) REFERENCES main.board_game(board_game_id) ON DELETE CASCADE;


--
-- Name: board_game_mechanic fk_board_game_mechanic_game; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.board_game_mechanic
    ADD CONSTRAINT fk_board_game_mechanic_game FOREIGN KEY (board_game_id) REFERENCES main.board_game(board_game_id) ON DELETE CASCADE;


--
-- Name: board_game_mechanic fk_board_game_mechanic_mechanic; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.board_game_mechanic
    ADD CONSTRAINT fk_board_game_mechanic_mechanic FOREIGN KEY (mechanic_id) REFERENCES main.mechanic(mechanic_id) ON DELETE CASCADE;


--
-- Name: game_release fk_game_release_board_game; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.game_release
    ADD CONSTRAINT fk_game_release_board_game FOREIGN KEY (board_game_id) REFERENCES main.board_game(board_game_id) ON DELETE CASCADE;


--
-- Name: game_release fk_game_release_publisher; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.game_release
    ADD CONSTRAINT fk_game_release_publisher FOREIGN KEY (publisher_id) REFERENCES main.publisher(publisher_id) ON DELETE RESTRICT;


--
-- Name: game_wish fk_game_wish_board_game; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.game_wish
    ADD CONSTRAINT fk_game_wish_board_game FOREIGN KEY (board_game_id) REFERENCES main.board_game(board_game_id) ON DELETE CASCADE;


--
-- Name: game_wish fk_game_wish_user; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.game_wish
    ADD CONSTRAINT fk_game_wish_user FOREIGN KEY (user_id) REFERENCES main.app_user(user_id) ON DELETE CASCADE;


--
-- Name: location fk_location_owner_user; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.location
    ADD CONSTRAINT fk_location_owner_user FOREIGN KEY (owner_user_id) REFERENCES main.app_user(user_id) ON DELETE CASCADE;


--
-- Name: play fk_play_board_game; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.play
    ADD CONSTRAINT fk_play_board_game FOREIGN KEY (board_game_id) REFERENCES main.board_game(board_game_id) ON DELETE CASCADE;


--
-- Name: play fk_play_location; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.play
    ADD CONSTRAINT fk_play_location FOREIGN KEY (location_id) REFERENCES main.location(location_id) ON DELETE SET NULL;


--
-- Name: play_participant fk_play_participant_play; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.play_participant
    ADD CONSTRAINT fk_play_participant_play FOREIGN KEY (play_id) REFERENCES main.play(play_id) ON DELETE CASCADE;


--
-- Name: play_participant fk_play_participant_user; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.play_participant
    ADD CONSTRAINT fk_play_participant_user FOREIGN KEY (user_id) REFERENCES main.app_user(user_id) ON DELETE CASCADE;


--
-- Name: play fk_play_winner; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.play
    ADD CONSTRAINT fk_play_winner FOREIGN KEY (winner_user_id) REFERENCES main.app_user(user_id) ON DELETE SET NULL;


--
-- Name: price fk_price_game_release; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.price
    ADD CONSTRAINT fk_price_game_release FOREIGN KEY (game_release_id) REFERENCES main.game_release(game_release_id) ON DELETE CASCADE;


--
-- Name: rating fk_rating_board_game; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.rating
    ADD CONSTRAINT fk_rating_board_game FOREIGN KEY (board_game_id) REFERENCES main.board_game(board_game_id) ON DELETE CASCADE;


--
-- Name: rating fk_rating_user; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.rating
    ADD CONSTRAINT fk_rating_user FOREIGN KEY (user_id) REFERENCES main.app_user(user_id) ON DELETE SET NULL;


--
-- Name: review fk_review_board_game; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.review
    ADD CONSTRAINT fk_review_board_game FOREIGN KEY (board_game_id) REFERENCES main.board_game(board_game_id) ON DELETE CASCADE;


--
-- Name: review fk_review_user; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.review
    ADD CONSTRAINT fk_review_user FOREIGN KEY (user_id) REFERENCES main.app_user(user_id) ON DELETE CASCADE;


--
-- Name: user_game_release fk_user_game_release_game; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.user_game_release
    ADD CONSTRAINT fk_user_game_release_game FOREIGN KEY (game_release_id) REFERENCES main.game_release(game_release_id) ON DELETE CASCADE;


--
-- Name: user_game_release fk_user_game_release_user; Type: FK CONSTRAINT; Schema: main; Owner: postgres
--

ALTER TABLE ONLY main.user_game_release
    ADD CONSTRAINT fk_user_game_release_user FOREIGN KEY (user_id) REFERENCES main.app_user(user_id) ON DELETE CASCADE;


--
-- Name: SCHEMA main; Type: ACL; Schema: -; Owner: postgres
--
...
--
-- Name: TABLE app_user; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: COLUMN app_user.user_id; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: COLUMN app_user.username; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE app_user_user_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE award; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE award_award_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE award_board_game; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE board_game; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE board_game_board_game_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE board_game_category; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE board_game_mechanic; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE category; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE category_category_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE game_release; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE mechanic; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE play; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE publisher; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE rating; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE game_catalog; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE game_wish; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE review; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE user_game_release; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE game_popularity_stats; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE price; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE game_prices_current; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE game_release_game_release_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE game_wish_game_wish_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE games_missing_metadata; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE location; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE location_location_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE mechanic_mechanic_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE play_participant; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE play_play_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE price_price_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE publisher_publisher_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE rating_rating_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: SEQUENCE review_review_id_seq; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE user_game_collection; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: TABLE user_play_history; Type: ACL; Schema: main; Owner: postgres
--
...
--
-- Name: DEFAULT PRIVILEGES FOR SEQUENCES; Type: DEFAULT ACL; Schema: main; Owner: postgres
--
...
--
-- Name: DEFAULT PRIVILEGES FOR TABLES; Type: DEFAULT ACL; Schema: main; Owner: postgres
--
...
--
-- Name: game_popularity_stats; Type: MATERIALIZED VIEW DATA; Schema: main; Owner: postgres
--
