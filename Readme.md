...
🚀 Sprawozdania z danych etapów są automatycznie generowane w formacie PDF z plików [Quarto](https://quarto.org/) przez GitHub Actions i publikowane na orphan branchach.
